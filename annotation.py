...
sound_dir = '/Users/nobuyuki/PycharmProjects/trimmed_validation_2sec/*.wav'
tpz_dir = '/Users/nobuyuki/PycharmProjects/trimmed_validation_tpz_2sec/*.wav'
sound_paths = glob.glob(sound_dir)
tpz_paths = glob.glob(tpz_dir)


csv_file = 'test_tpz_2sec.csv'
